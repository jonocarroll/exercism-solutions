...
public class ParallelLetterFrequencyTest {
    ...
    private String calculateFrecuencies = "There, peeping among the cloud-wrack above a dark tower high up in the mountains,"
            +
    ...
    private String largeTexts1 = "I am a sick man.... I am a spiteful man. I am an unattractive man.\n" +
    ...
    private String largeTexts2 = "Gentlemen, I am joking, and I know myself that my jokes are not brilliant\n" +
    ...
    private String largeTexts3 = "But these are all golden dreams. Oh, tell me, who was it first announced,\n" +
    ...
    private String largeTexts4 = "Yes, but here I come to a stop! Gentlemen, you must excuse me for being over-philosophical;\n"
            +
