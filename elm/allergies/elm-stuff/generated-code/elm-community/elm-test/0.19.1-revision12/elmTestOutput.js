...
var $author$project$Allergies$Cats = {$: 'Cats'};
var $author$project$Allergies$Chocolate = {$: 'Chocolate'};
var $author$project$Allergies$Eggs = {$: 'Eggs'};
var $author$project$Allergies$Peanuts = {$: 'Peanuts'};
var $author$project$Allergies$Pollen = {$: 'Pollen'};
var $author$project$Allergies$Shellfish = {$: 'Shellfish'};
var $author$project$Allergies$Strawberries = {$: 'Strawberries'};
var $author$project$Allergies$Tomatoes = {$: 'Tomatoes'};
var $author$project$Tests$allergySort = function () {
	var allergyOrder = function (allergy) {
		switch (allergy.$) {
			case 'Eggs':
				return 1;
			case 'Peanuts':
	...
	return $elm$core$List$sortBy(allergyOrder);
}();
...
var $author$project$Allergies$toList = function (score) {
	toList:
	while (true) {
		if (score >= 256) {
			var $temp$score = score - 256;
			score = $temp$score;
			continue toList;
		} else {
			if (score >= 128) {
				return _Utils_ap(
					$author$project$Allergies$toList(score - 128),
					_List_fromArray(
						[$author$project$Allergies$Cats]));
			} else {
				if (score >= 64) {
					return _Utils_ap(
						$author$project$Allergies$toList(score - 64),
						_List_fromArray(
							[$author$project$Allergies$Pollen]));
				} else {
					if (score >= 32) {
						return _Utils_ap(
							$author$project$Allergies$toList(score - 32),
							_List_fromArray(
								[$author$project$Allergies$Chocolate]));
					} else {
						if (score >= 16) {
							return _Utils_ap(
								$author$project$Allergies$toList(score - 16),
								_List_fromArray(
									[$author$project$Allergies$Tomatoes]));
						} else {
							if (score >= 8) {
								return _Utils_ap(
									$author$project$Allergies$toList(score - 8),
									_List_fromArray(
										[$author$project$Allergies$Strawberries]));
							} else {
								if (score >= 4) {
									return _Utils_ap(
										$author$project$Allergies$toList(score - 4),
										_List_fromArray(
											[$author$project$Allergies$Shellfish]));
								} else {
									if (score >= 2) {
										return _Utils_ap(
											$author$project$Allergies$toList(score - 2),
											_List_fromArray(
												[$author$project$Allergies$Peanuts]));
									} else {
										if (score === 1) {
											return _List_fromArray(
												[$author$project$Allergies$Eggs]);
										} else {
											return _List_Nil;
										}
									}
...
var $author$project$Allergies$isAllergicTo = F2(
	function (allergy, score) {
		return A2(
			$elm$core$List$member,
			allergy,
			$author$project$Allergies$toList(score));
	});
var $elm_explorations$test$Test$Internal$ElmTestVariant__Skipped = function (a) {
	return {__elmTestSymbol: __elmTestSymbol, $: 'ElmTestVariant__Skipped', a: a};
};
var $elm_explorations$test$Test$skip = $elm_explorations$test$Test$Internal$ElmTestVariant__Skipped;
				...
				[
					...
					function (_v0) {
						return A2(
							...
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Eggs, 0));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Eggs, 1));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Eggs, 3));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Eggs, 2));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Eggs, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v5) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Peanuts, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Peanuts, 2));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Peanuts, 7));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Peanuts, 5));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Peanuts, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v10) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Shellfish, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Shellfish, 4));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Shellfish, 14));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v13) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Shellfish, 10));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v14) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Shellfish, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v15) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Strawberries, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v16) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Strawberries, 8));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v17) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Strawberries, 28));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v18) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Strawberries, 20));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v19) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Strawberries, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v20) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Tomatoes, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v21) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Tomatoes, 16));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v22) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Tomatoes, 56));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v23) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Tomatoes, 40));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v24) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Tomatoes, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v25) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Chocolate, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v26) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Chocolate, 32));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v27) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Chocolate, 112));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v28) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Chocolate, 80));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v29) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Chocolate, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v30) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Pollen, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v31) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Pollen, 64));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v32) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Pollen, 224));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v33) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Pollen, 160));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v34) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Pollen, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v35) {
							return A2(
								$elm_explorations$test$Expect$equal,
								false,
								A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Cats, 0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v36) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Cats, 128));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v37) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Cats, 192));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v38) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Cats, 64));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'allergic to everything',
					function (_v39) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A2($author$project$Allergies$isAllergicTo, $author$project$Allergies$Cats, 255));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
				...
				[
					...
					A2(
						...
						function (_v40) {
							return A2(
								$elm_explorations$test$Expect$equal,
								_List_Nil,
								$author$project$Allergies$toList(0));
						})),
					A2(
					$elm_explorations$test$Test$test,
					'just eggs',
					function (_v41) {
						return A2(
							...
							_List_fromArray(
								[$author$project$Allergies$Eggs]),
							$author$project$Allergies$toList(1));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'just peanuts',
					function (_v42) {
						return A2(
							...
							_List_fromArray(
								[$author$project$Allergies$Peanuts]),
							$author$project$Allergies$toList(2));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'just strawberries',
					function (_v43) {
						return A2(
							...
							_List_fromArray(
								[$author$project$Allergies$Strawberries]),
							$author$project$Allergies$toList(8));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'eggs and peanuts',
					function (_v44) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$Tests$allergySort(
								_List_fromArray(
									[$author$project$Allergies$Eggs, $author$project$Allergies$Peanuts])),
							$author$project$Tests$allergySort(
								$author$project$Allergies$toList(3)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v45) {
						return A2(
							...
							$author$project$Tests$allergySort(
								_List_fromArray(
									[$author$project$Allergies$Eggs, $author$project$Allergies$Shellfish])),
							$author$project$Tests$allergySort(
								$author$project$Allergies$toList(5)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'lots of stuff',
					function (_v46) {
						return A2(
							...
							$author$project$Tests$allergySort(
								_List_fromArray(
									[$author$project$Allergies$Strawberries, $author$project$Allergies$Tomatoes, $author$project$Allergies$Chocolate, $author$project$Allergies$Pollen, $author$project$Allergies$Cats])),
							$author$project$Tests$allergySort(
								$author$project$Allergies$toList(248)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'everything',
					function (_v47) {
						return A2(
							...
							$author$project$Tests$allergySort(
								_List_fromArray(
									[$author$project$Allergies$Eggs, $author$project$Allergies$Peanuts, $author$project$Allergies$Shellfish, $author$project$Allergies$Strawberries, $author$project$Allergies$Tomatoes, $author$project$Allergies$Chocolate, $author$project$Allergies$Pollen, $author$project$Allergies$Cats])),
							$author$project$Tests$allergySort(
								$author$project$Allergies$toList(255)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v48) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_List_fromArray(
								[$author$project$Allergies$Eggs, $author$project$Allergies$Shellfish, $author$project$Allergies$Strawberries, $author$project$Allergies$Tomatoes, $author$project$Allergies$Chocolate, $author$project$Allergies$Pollen, $author$project$Allergies$Cats]),
							$author$project$Allergies$toList(509));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v49) {
						return A2(
							...
							_List_fromArray(
								[$author$project$Allergies$Eggs]),
							$author$project$Allergies$toList(257));
					})
				]))
		]));
...
var pipeFilename = "/tmp/elm_test-290207.sock";
var net = require('net'),
